 ...
 * Get Messages
 */
export const coreApiGetMessages = <ThrowOnError extends boolean = false>(options?: Options<CoreApiGetMessagesData, ThrowOnError>) => (options?.client ?? client).get<CoreApiGetMessagesResponses, unknown, ThrowOnError>({ url: '/api/messages/', ...options });
 ...
 * Import Into Recipe
 */
export const mealsApiRecipesImportIntoRecipe = <ThrowOnError extends boolean = false>(options: Options<MealsApiRecipesImportIntoRecipeData, ThrowOnError>) => (options.client ?? client).post<MealsApiRecipesImportIntoRecipeResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
        }],
    url: '/api/meals/recipes/{recipe_id}/import',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 */
export const mealsApiShoppingSharedShoppingListEvents = <ThrowOnError extends boolean = false>(options: Options<MealsApiShoppingSharedShoppingListEventsData, ThrowOnError>) => (options.client ?? client).get<MealsApiShoppingSharedShoppingListEventsResponses, unknown, ThrowOnError>({ url: '/api/meals/shared/shopping-lists/{token}/events', ...options });
